...
Phase 14: RBAC & route-auth coverage hardening (no new feature — closes an existing test gap)
Phase 15: staff operational notifications (Resend email on new custom request/order)
